...
while True:
    ...
    n = neighbours(qs_p[0],qs_p[1],skeleton_image_cy)
    # testli11111([[qs_p[1],qs_p[0]]],img1,(255,0,0))
    n_p = neighbours_x_y(qs_p[0],qs_p[1])
    print(n)
    k = np.argwhere(np.array(n) > 200)
    last_p  = n_p[int(k[0])]
    print(k)
    print(last_p)
    while True:
