...
def find_oth_jiaodian(d_a,d_b,d_c,d_d,al_bh):
    jl_list = []
...
def getFork_posion(fork_list,all_bihua_list):
    ...
    for bihua in all_bihua_list:
        ...
        if jl_list==[None]:
            ...
            find_oth_jiaodian(a,b,c,d,all_bihua_list)
...
img1 = cv2.imread('images/1111.png', cv2.IMREAD_GRAYSCALE)  # 读取图像
# img1 = cv2.imread('images/test5.png')  # 读取图像
if len(img1.shape) > 2:
    h1, w1, n = img1.shape
    img2 = img1[::, 2]
else:
...
# print(contours)
# print(len(contours))
# testli(contours[0],new_img,(255,255,255))

# threshold = threshold_image(img2)
